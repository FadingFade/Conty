...
wine_pkgs="wine-staging winetricks-git alsa-lib alsa-plugins cups dosbox ffmpeg giflib gnutls gst-plugins-base-libs \
	gtk3 lib32-alsa-lib lib32-alsa-plugins lib32-giflib lib32-gnutls lib32-gst-plugins-base-libs lib32-gtk3 \
 	lib32-libcups lib32-libpulse lib32-libva lib32-libxcomposite lib32-libxinerama lib32-ocl-icd lib32-sdl2-compat \
 	lib32-v4l-utils lib32-vulkan-icd-loader libgphoto2 libpulse libva libxcomposite libxinerama ocl-icd samba sane \
  	sdl2-compat v4l-utils vulkan-icd-loader"

game_pkgs="steam prismlauncher mcpelauncher-ui-git mcpelauncher-linux-git"

# Packages to install
# You can add packages that you want and remove packages that you don't need
# Apart from packages from the official Arch repos, you can also specify
# packages from the Chaotic-AUR repo
export packagelist="pipewire-pulse pipewire-alsa jre17-openjdk zenity chromium ${wine_pkgs} ${game_pkgs}"
