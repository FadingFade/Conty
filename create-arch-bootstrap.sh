...
game_pkgs="prismlauncher mcpelauncher-linux-git mcpelauncher-ui-git steam"

# Packages to install
# You can add packages that you want and remove packages that you don't need
# Apart from packages from the official Arch repos, you can also specify
# packages from the Chaotic-AUR repo
export packagelist="pipewire-alsa pipewire-pulse jre17-openjdk wget zenity brave-bin ${wine_pkgs} ${game_pkgs}"
