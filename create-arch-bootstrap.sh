...
wine_pkgs="wine-staging winetricks-git alsa-lib alsa-plugins cups dosbox ffmpeg giflib gnutls gst-plugins-base-libs \
	   ...
	   lib32-gtk3 lib32-libpulse lib32-libva lib32-libxcomposite lib32-gst-plugins-good lib32-libxinerama lib32-ocl-icd \
           lib32-sdl2 lib32-v4l-utils lib32-vulkan-icd-loader libgphoto2 libpulse libva libxcomposite libxinerama \
	   ocl-icd samba sane sdl2 v4l-utils vulkan-icd-loader"

game_pkgs="steam prismlauncher-git mcpelauncher-linux-git mcpelauncher-ui-git"

# Packages to install
# You can add packages that you want and remove packages that you don't need
# Apart from packages from the official Arch repos, you can also specify
# packages from the Chaotic-AUR repo
export packagelist="${core_pkgs} ${wine_pkgs} ${game_pkgs}"
