...
# Package groups
wine_pkgs="wine-staging winetricks-git alsa-lib alsa-plugins cups dosbox ffmpeg giflib gnutls \
	gst-plugins-base-libs gtk3 lib32-alsa-lib lib32-alsa-plugins lib32-giflib lib32-gnutls \
...
export packagelist="${game_pkgs} ${wine_pkgs} pipewire-alsa pipewire-pulse zenity chromium jre17-openjdk"
